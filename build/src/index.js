...
async function runCliCommand(handler, args) {
...
async function main() {
    const cliArgs = yargs(hideBin(process.argv))
        ...
        .command('next', 'Get the next task to work on (simple logic)', (y) => y.option('random_string', { type: 'string', default: 'dummy', hidden: true }), (argv) => runCliCommand(getNextTaskHandler, argv))
        ...
        .command('dashboard', 'Display task dashboard', (y) => y.option('random_string', { type: 'string', default: 'dummy', hidden: true }), (argv) => runCliCommand(visualizeTasksDashboardHandler, argv))
